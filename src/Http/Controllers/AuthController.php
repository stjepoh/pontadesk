...
final class AuthController
{
    ...
    private function render(string $title, string $content): void
    {
        ...
        echo '<style>body{font-family:Arial,sans-serif;background:#0f172a;color:#e2e8f0;margin:0;padding:40px}.card{max-width:560px;margin:0 auto;background:#111827;border:1px solid #334155;border-radius:16px;padding:28px}.login-brand{display:flex;align-items:center;gap:12px;margin-bottom:20px}.login-brand img{width:54px;height:54px;border-radius:14px;object-fit:cover;background:#fff}.login-brand strong{display:block;font-size:20px}.input,.btn{width:100%;box-sizing:border-box;padding:12px 14px;border-radius:10px;border:1px solid #334155}.input{background:#0b1220;color:#e2e8f0}.btn{background:#2563eb;color:#fff;cursor:pointer}.muted{color:#94a3b8}</style></head><body><main class="card"><div class="login-brand"><img src="/assets/img/ponta-app-logo.png" alt="PontaDesk"><div><strong>PontaDesk</strong><span class="muted">Admin pristup aplikaciji</span></div></div><h1>Prijava</h1><p class="muted">Admin pristup PontaDesk aplikaciji.</p>' . $content . '</main></body></html>';
    }
